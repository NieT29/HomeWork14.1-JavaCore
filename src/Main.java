...
public class Main {
    public static void main(String[] args) {
        ...
        petList.add(new Pet( 4,"Pet4", "Species4", 4, "Female", "Des4", TYPE.DOG, "Image 4"));
        ...
        petList.add(new Pet( 7,"Pet7", "Species7", 3, "Male", "Des7", TYPE.CAT, "Image 7"));
        petList.add(new Pet( 8,"Pet8", "Species8", 1, "Male", "Des8", TYPE.CAT, "Image 8"));
        petList.add(new Pet( 9,"Pet9", "Species9", 2, "Female", "Des9", TYPE.CAT, "Image 9"));
